...
export default function AddSpotModal({
  ...
  async function submit(e: FormEvent) {
    ...
    if (!name.trim() || !address.trim() || Number.isNaN(parsedLat) || Number.isNaN(parsedLng)) {
      alert('장소명, 주소, 위도, 경도는 필수입니다.');
      return;
    }
    ...
    const spot: Spot = {
      ...
      tags: splitList(tags),
      description: description.trim() || '제보된 장소입니다. 상세 정보가 필요합니다.',
      takeoffPoint: takeoffPoint.trim() || '이륙 포인트 정보가 필요합니다.',
      ...
      <form className="modal" onSubmit={submit}>
        ...
        <label>
          ...
          <input
            ...
            placeholder="전선, 나무, 군부대, 민가, 바람 강함"
          />
        </label>
